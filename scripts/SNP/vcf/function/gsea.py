...
if __name__ == "__main__":
    ...
    # )
    ################ gsea preprank
    geneRank = pd.read_csv("/disk5/luosg/Totipotent20251031/output/SNP/vcf/intersect/annotate/ci8CLC/ci8CLC_gene_counts.csv",index_col=0)
    
    gsea_results = run_gsea(geneRank,
                            "/disk5/luosg/Totipotent20251031/data/geneset/GSI.gmt",
                            "/disk5/luosg/Totipotent20251031/output/SNP/vcf/intersect/annotate/ci8CLC/gsea")
