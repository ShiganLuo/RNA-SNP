...
if __name__ == "__main__":
    ...
    convert_matrix_gene_ids("/disk5/luosg/Totipotent20251031/output/counts/featureCounts/Homo_sapiens/Homo_sapiens_paired_tpm.tsv",
                            gtf_path=human_gtf,
                            cache_path="GRCh38_gene_map.pkl",
                            save_path="/disk5/luosg/Totipotent20251031/output/counts/featureCounts/Homo_sapiens/Homo_sapiens_paired_name_tpm.tsv")
    convert_matrix_gene_ids("/disk5/luosg/Totipotent20251031/output/counts/featureCounts/Mus_musculus/Mus_musculus_paired_tpm.tsv",
                        gtf_path=mouse_gtf,
                        cache_path="GRCm39_gene_map.pkl",
                        save_path="/disk5/luosg/Totipotent20251031/output/counts/featureCounts/Mus_musculus/Mus_musculus_paired_name_tpm.tsv")
    #### totionly
    # files = {
