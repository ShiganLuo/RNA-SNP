...
def commonExpression(infile:str,outfile:str,threshold:int=1):
    """
    ...
    mask = ~(df.iloc[:, 1:].to_numpy() < threshold).any(axis=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--threshold', type=int, required=True, help='threshold to filter gene matrix')
    ...
    # print(infile)
    # print(outfile)
    commonExpression(infile,outfile,threshold)