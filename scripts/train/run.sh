...
python ${latent_factor_analysis} \
    ...
    --method fa \
    --k 5 \
    --prefix /home/luosg/Data/genomeStability/output/result/latent/factor/fa 

python ${latent_factor_analysis} \
    --resid ${resid} \
    --method nmf \
    --k 5 \
    --prefix /home/luosg/Data/genomeStability/output/result/latent/nmf/nmf_out

python ${latent_factor_analysis} \
    --resid ${resid} \
    --method pca \
    --k 5 \
    --prefix /home/luosg/Data/genomeStability/output/result/latent/pca/pca_out
